  ...
  <body >
    <div class="container justify-content-center py-5 align-items-center">
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-6 mt-3">
                <div class="">
                    <img src="https://images.unsplash.com/photo-1459749411175-04bf5292ceea?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" srcset="" width="600px" class="rounded">
                </div>
            </div>
        </div>
    </div>
